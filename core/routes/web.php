...
Route::get('/cacheclear', function () {
            ...
            dd('System Cache Has Been Removed.');
        });
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            //     return redirect('/');
            // })->name('user.login');
            Route::get('/login', 'Auth\User\LoginController@showloginForm')->name('user.login2');
            Route::get('/auth', 'Auth\User\LoginController@showForm')->name('user.login');
        ...
        //------------ CATALOG ------------
        Route::get('/post_ad', 'Front\CatalogController@post_ad')->name('front.post_ad');
        Route::post('/post_ad', 'Front\CatalogController@storePost_ad')->name('front.post_ad.store');
        Route::get('/workshop_booking', 'Front\CatalogController@workshop_booking')->name('front.workshop_booking');
